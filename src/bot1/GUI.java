...
public class GUI extends JFrame implements WindowListener, ActionListener {
    ...
    public final String activity = "Gaust er m�r";
    ...
    public GUI(final String title) {
        ...
        button = new JButton("Er gaust m�r?");
        button2 = new JButton("M�rcounter");
        button3 = new JButton("Reset M�r");
    ...
    public void actionPerformed(final ActionEvent e) {
        if (e.getSource() == button) {
        	Main.setActivity("Gaust er m�r");
        }
        if (e.getSource() == button2) {
        	Main.setActivity(Commands.mør + "x m�r");
        }
    ...
    public void HideGUI() {
        ...
        if (SystemTray.isSupported()) {
            ...
            popup.add(defaultItem);
            trayIcon = new TrayIcon(image, "M�r Bot", popup);
